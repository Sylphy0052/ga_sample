...
def main():
    n_gene = 100 # genes number
    n_ind = 300 # individuals in population number
    CXPB = 0.5 # probability of crossover
    MUTPB = 0.2 # probability of gene mutation
    MUTINDPB = 0.05 # probability of gene mutation
    NGEN = 40 # generation loop number
